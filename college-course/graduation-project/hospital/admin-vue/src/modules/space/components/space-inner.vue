      ...
      <template #right>
        <div class="cl-upload-space-inner__right">
          ...
          <div class="cl-upload-space-inner__header">
            <el-button @click="refresh({ page: 1 })">
              {{ $t('刷新') }}
            </el-button>
            ...
            <template v-if="!selectable">
              <el-button type="danger" :disabled="selection.length == 0" @click="remove()">
                {{
                  $t('删除选中文件')
                }}
              </el-button>
            ...
            <template v-if="list.length > 0">
              ...
              >
                ...
                >
                  ...
                  <!-- 已选序号 -->
                  <div v-show="onIndex(item.id)" class="cl-upload-space-inner__file-index">
